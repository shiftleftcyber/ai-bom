...
This site publishes the AI SBOM JSON Schema for direct consumption by validators, CI workflows, and other automation.
...
```text
https://github.com/shiftleftcyber/ai-bom
```
